...
func EncryptWithAES128CFB(key []byte, plainData []byte) (*AesData, error) {
...
func EncryptWithAES192CFB(key []byte, plainData []byte) (*AesData, error) {
...
func EncryptWithAES256CFB(key []byte, plainData []byte) (*AesData, error) {
